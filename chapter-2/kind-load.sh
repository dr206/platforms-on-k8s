...
kind load docker-image -n dev bitnamilegacy/redis:7.0.11-debian-11-r12
kind load docker-image -n dev bitnamilegacy/postgresql:15.3.0-debian-11-r17
kind load docker-image -n dev bitnamilegacy/kafka:3.4.1-debian-11-r0
